...
typedef minimum_time_reachability<typeparams,5> min_time_reachability_t;
...
main () {
  ...
  planner.parameters.set_max_radius (15.0);  // This parameter is expecially capped to a certain to limit
  ...
  // 2.e Initialize the model checker and the cost evaluator (with minimum_time_reachability).
