...
int main( int argc, char **argv )
{
	...
	/* NOTE that the formula is currently hard-coded in
	   ParseTree::parseFormula() as the parse tree provided in
	   parseFormulaLoop4(), both defined in the file inc_mu_mc/pt.cpp */
	...
	// std::ofstream outf( "arena.dot" );
	// planner.dumpArenaDOT( outf );
	// outf.close();
