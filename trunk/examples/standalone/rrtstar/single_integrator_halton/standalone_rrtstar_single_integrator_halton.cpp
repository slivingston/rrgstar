...
#include <smp/components/samplers/halton.hpp>                       
...
// *
#define NUM_DIMENSIONS 3     // Change the number of dimensions from here. Scale it up to 6 - 10 
...
#define EXTENSION_LENGTH  10.0   // Maximum length of an extension. This parameter should ideally 
...
typedef sampler_halton<typeparams,NUM_DIMENSIONS> sampler_t;
...
main () {
  ...
  planner.init_cost_evaluator (min_time_reachability);
